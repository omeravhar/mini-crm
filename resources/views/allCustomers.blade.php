...
<style>
  ...
  <!-- <nav class="navbar navbar-expand-lg bg-white border-bottom small">
    <div class="container-fluid">
      <a class="navbar-brand fw-semibold" href="#"><i class="bi bi-boxes me-2"></i>EasyCRM</a>
            ...
            <table class="table table-hover" id="customersTable">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>יואב</td>
                        <td>כהן</td>
                        <td>yoav@example.com</td>
                        <td>+972-50-123-4567</td>
                        <td>
                            <button class="btn btn-sm btn-primary viewCustomerBtn" 
                                data-bs-toggle="modal" 
                                data-bs-target="#customerModal"
                                data-customer='{"id":1,"first_name":"יואב","last_name":"כהן","email":"yoav@example.com","phone":"+972-50-123-4567","company":"Example Ltd","job_title":"מנהל","website":"https://example.com"}'>
                                צפייה / עריכה
                            </button>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-sm btn-primary viewCustomerBtn" 
                                data-bs-toggle="modal" 
                                data-bs-target="#customerModal"
                                data-customer='{"id":2,"first_name":"נועה","last_name":"שפירא","email":"noa@example.com","phone":"+972-52-987-6543","company":"Acme Corp","job_title":"מנכ\"לית","website":"https://acme.com"}'>
                                צפייה / עריכה
                            </button>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>דניאלה</td>
                        <td>לוי</td>
                        <td>daniella@example.com</td>
                        <td>+972-54-555-1234</td>
                        <td>
                            <button class="btn btn-sm btn-primary viewCustomerBtn" 
                                data-bs-toggle="modal" 
                                data-bs-target="#customerModal"
                                data-customer='{"id":3,"first_name":"דניאלה","last_name":"לוי","email":"daniella@example.com","phone":"+972-54-555-1234","company":"Tech Solutions","job_title":"מפתחת","website":"https://techsolutions.com"}'>
                                צפייה / עריכה
                            </button>
                        </td>
                    </tr>
    ...
    <div class="modal-content">
      <form id="customerForm" method="POST" class="needs-validation" novalidate>
        ...
        <div class="modal-header">
          <h5 class="modal-title" id="customerModalLabel">פרטי לקוח</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <div class="row g-3">
            <div class="col-md-6">
              <label for="firstNameModal" class="form-label required">שם פרטי</label>
              <input type="text" class="form-control" id="firstNameModal" name="first_name" required>
            </div>
            <div class="col-md-6">
              <label for="lastNameModal" class="form-label required">שם משפחה</label>
              <input type="text" class="form-control" id="lastNameModal" name="last_name" required>
            </div>
            <div class="col-md-8">
              <label for="emailModal" class="form-label required">דוא"ל</label>
              <input type="email" class="form-control" id="emailModal" name="email" required>
            </div>
            <div class="col-md-4">
              <label for="phoneModal" class="form-label">טלפון</label>
              <input type="tel" class="form-control" id="phoneModal" name="phone">
            </div>
            <div class="col-md-12">
              <label for="companyModal" class="form-label">חברה</label>
              <input type="text" class="form-control" id="companyModal" name="company">
            </div>
            <div class="col-md-6">
              <label for="titleModal" class="form-label">תפקיד</label>
              <input type="text" class="form-control" id="titleModal" name="job_title">
            </div>
            <div class="col-md-6">
              <label for="websiteModal" class="form-label">אתר אינטרנט</label>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary">עדכון לקוח</button>
        </div>
      </form>
    </div>
  </div>
