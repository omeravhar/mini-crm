...
<body class="d-flex align-items-center py-4 bg-body-tertiary"> <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    <main class="form-signin w-100 m-auto">
        <form method="post" action="{{url('login')}}"> 
            <img class="mb-4"  src={{asset("assets/Logo-white.d110a0.webp")}} alt="" width="100%" height="57">
            <h1 class="h3 mb-3 fw-normal">התחברות למערכת</h1>
            <div class="form-floating"> 
                <input type="email" name="email" class="form-control" id="floatingInput" placeholder="user@example.com"  value="{{ old('email') }}"> 
                <label for="floatingInput">דוא"ל</label> 
            </div>
                <div class="form-floating"> 
                <input type="password" name="password" class="form-control" id="floatingPassword" placeholder="סיסמה"> 
            ...
            <div class="form-check text-start my-3"> <input class="form-check-input" type="checkbox" value="remember-me" id="checkDefault"> <label class="form-check-label" for="checkDefault">
                    זכור אותי
                </label> </div> <button class="btn btn-primary w-100 py-2" type="submit">כניסה</button>
