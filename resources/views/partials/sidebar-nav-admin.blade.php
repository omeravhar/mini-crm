<div class="nav nav-pills flex-column gap-2">
    ...
    @if (auth()->user()->isAdmin())
        ...
        <a class="nav-link @if(request()->routeIs('admin.auth-activity.*')) active @endif" href="{{ route('admin.auth-activity.index') }}">
            <i class="bi bi-shield-check me-2"></i>לוגי התחברות
        </a>
